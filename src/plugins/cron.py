...
scheduler.add_job(cron_hpadd, "interval", seconds=1, id="hpadd")
...
scheduler.add_job(cron_conadd, "interval", seconds=144, id="conadd")
...
scheduler.add_job(cron_mpadd, "interval", seconds=1, id="mpadd")
...
scheduler.add_job(cron_lvup, "interval", seconds=1, id="lvup")
