                ...
                if nowmap != str(hscmmap):
                    ...
                    if con == 0:
                        ...
                        if hp<=0:
                            ...
                            w_batdata(ran_num1,str1,hs_hp,hs_mp,username,sp2,sp3,sp4,sp5,sp6,sp7,starttime,starttime,starttime)
        ...
        if hs_hp <= 0:
            ...
            if int(hs_hshjsf) == 1:
                ...
                if f1 == 0:
                    ...
                    hshj = get_hshj(hshjlist)#获得字典
                    allhjgl = []
                    allhjname = []
                    a =len(hshj)
                    for v in hshj:
                        allhjgl.append(hshj[v])
                    for ke in hshj.keys():
                        allhjname.append(ke)
                    p = random_run2(allhjgl)
                    hjname = allhjname[p]#即将释放的魂技名
